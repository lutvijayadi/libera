...
<body class="bg-gray-100 font-poppins">
    ...
    <main class="p-6">
        ...
        <!-- HEADER -->
        <section>
            <div class="bg-linear-to-r from-[#2563eb] via-[#3b82f6] to-[#60a5fa] p-6 rounded-2xl shadow-lg text-white">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div
                    ...
                    <div>
                        ...
                        <h2 class="text-3xl font-bold text-blue-600 mt-2"><?= $total_buku ?></h2>
                    </div>
                ...
                <div
                    ...
                    <div>
                        ...
                        <h2 class="text-3xl font-bold text-blue-500 mt-2"><?= $total_pinjam ?></h2>
                    </div>
