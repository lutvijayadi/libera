                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-col items-center justify-center gap-1">
                                        <?php if (!empty($row['bukti_kembali'])) { ?>
                                            <a href="../uploads/bukti/<?php echo $row['bukti_kembali']; ?>" target="_blank">
                                                <img src="../uploads/bukti/<?php echo $row['bukti_kembali']; ?>"
                                                    class="w-16 h-12 object-cover rounded-lg border shadow hover:scale-110 transition">
                                            </a>
                                            <span class="text-[10px] text-gray-400">Bukti</span>
                                        <?php } else { ?>
